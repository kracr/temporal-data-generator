...
See [EXPERIMENTS.md](EXPERIMENTS.md) for the full, verified commands used to
(re)generate the thesis's experimental results (C-SPARQL2 evaluation, RDFox
evaluation, and the new repository contents added to support them).